      ...
      <div className="max-w-2xl mx-auto flex flex-col sm:flex-row justify-center items-center gap-6 text-muted-foreground">
        ...
        <div className="flex flex-row gap-2">
          ...
          <a
            ...
            title="Feedback via Nostr"
            className="flex items-center gap-2.5 text-muted-foreground hover:text-foreground transition-colors duration-200 hover:scale-105"
          >
            <svg
              className="h-5 w-5 text-muted-foreground hover:text-foreground transition-colors duration-200 hover:scale-105"
              viewBox="0 0 875 875"
            >
              <path
                fill="currentColor"
            ...
            {/* <span className="font-medium">xavierdamman.com</span> */}
          </a>{" "}
          <a
            href="https://x.com/xdamman"
            target="_blank"
            title="X / Twitter"
            rel="noopener noreferrer"
            className="flex items-center gap-2.5 text-muted-foreground hover:text-foreground transition-colors duration-200 hover:scale-105"
          >
            ...
            {/* <span className="font-medium">@xdamman</span> */}
          </a>
        </div>
      </div>
    </footer>
